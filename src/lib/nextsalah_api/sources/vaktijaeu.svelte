...
<Form FormData={FormData}>
    <Label>
        ...
        <Select class="mt-2" bind:value={country_selected} items={all_countries} itemValue="short_code" itemText="name" required/>
    {#if country_selected}
        <Label class="mt-2">
            Choose a city
            <Select bind:value={city_selected} items={all_cities[country_selected]} itemValue="short_code" itemText="name" name="location_slug" required/>
        </Label>
    {/if}
</Form>
